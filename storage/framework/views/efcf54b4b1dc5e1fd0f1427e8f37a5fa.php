...
<?php $__env->startSection('title','Barang Masuk | TokoKu'); ?>
...
<?php echo $__env->make('productIn.detailProductIn', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function(){
        $('#productIn-table').DataTable({
            ...
            serverSide: true,
			"bDestroy": true,
            ajax: "<?php echo e(url('barang-masuk')); ?>",
            columns: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\project\laravel\projects\kasir-app\resources\views/productIn/dataProductIn.blade.php ENDPATH**/ ?>