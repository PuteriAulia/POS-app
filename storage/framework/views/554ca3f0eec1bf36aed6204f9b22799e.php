...
<?php $__env->startSection('title','Kasir | TokoKu'); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="block block-rounded">
                <div class="block-content p-3">
                    ...
                    <div class="font-size-h2 text-dark" id="invoice"><?php echo e($inv); ?></div>
                </div>
            </div>
            <!-- End choose product -->
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
            ...
            <div class="block block-rounded">
                <div class="block-content p-3">
                    ...
                    <div class="font-size-h2 font-w400 text-dark" id="startTotal"><?php echo e(rupiahFormat($total)); ?></div>
        ...
        <div class="block-content">
            ...
            <div class="form-group">
                <form action="/kasir" method="POST">
                    <div class="row">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" class="form-control form-control-alt" name="inv" value="<?php echo e($inv); ?>">
...
<?php echo $__env->make('cashier.formAddProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('cashier.formPayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\project\laravel\projects\kasir-app\resources\views/cashier/cashier.blade.php ENDPATH**/ ?>