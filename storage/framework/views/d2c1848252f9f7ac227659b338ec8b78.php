            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href="/barang-masuk">Data</a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.mainLayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\project\laravel\projects\kasir-app\resources\views/productIn/formStoreProductIn.blade.php ENDPATH**/ ?>