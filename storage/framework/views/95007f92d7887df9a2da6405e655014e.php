        ...
        <div class="block block-rounded">
            <?php foreach ($transaction as $data) { ?>
                <div class="block-header">
                    <h1 class="block-title"><?= ucwords($data->user->name) ?> | <?= $data->transaction_code ?></h1>
                </div>
            <?php } ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="font-w600 mb-1"><?php echo e(ucwords($data->product->product_name)); ?></p>
                                    </td>
                                    <td class="text-right"><?php echo e(rupiahFormat($data->product->product_sell)); ?></td>
                                    <td class="text-center">
                                        <p><?php echo e($data->detail_qty); ?></p>
                                    </td>
                                    <td class="text-right"><?php echo e(rupiahFormat($data->detail_subtotal)); ?></td>
                                </tr>
                                <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?php echo e(rupiahFormat($data->transaction_total)); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="font-w600 text-right">Diskon</td>
                                    <td class="text-right"><?php echo e(rupiahFormat($data->transaction_disc)); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" class="font-w700 text-uppercase text-right bg-body-light">Grand total</td>
                                    <td class="font-w700 text-right bg-body-light"><?php echo e(rupiahFormat($data->transaction_grand_total)); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
...
</html><?php /**PATH D:\XAMPP\htdocs\project\laravel\projects\kasir-app\resources\views/transaction/printTransaction.blade.php ENDPATH**/ ?>